...
export default function StatusBar() {
  ...
  return (
    <div className="bg-white/90 dark:bg-warehouse-panel/90 backdrop-blur-md text-gray-900 dark:text-warehouse-text-primary px-4 py-2.5 rounded-lg shadow-lg border border-gray-300 dark:border-warehouse-border">
      <div className="flex flex-col gap-1">
        {dataset && (
          <div className="text-sm font-medium">{dataset.name}</div>
        )}
        <div className="text-xs text-gray-600 dark:text-warehouse-text-secondary">
