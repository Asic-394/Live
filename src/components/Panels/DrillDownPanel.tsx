...
export default function DrillDownPanel() {
  ...
  // Don't show if no KPI is selected or no drill-down data
    ...
    return (
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-400 group-hover:text-gray-200">{kpi.label}</span>
        </div>
      </button>
    );
  }
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs px-3 py-1.5 rounded-lg bg-blue-400/20 
                           text-blue-300 hover:bg-blue-400/30 
